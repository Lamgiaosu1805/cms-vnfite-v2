...
import { Calendar, Edit3, Eye, ImagePlus, Loader2, Newspaper, Plus, Save, Search, Trash2, X } from 'lucide-react';
import {
  createNews,
  deleteNews,
  fetchNews,
...
function NewsEditorModal({ state, onClose, onSaved }: {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'min-h-72 outline-none px-4 py-3 text-sm text-gray-900 dark:text-gray-100',
      },
    },
    onUpdate: ({ editor }) => {
            ...
            <div className="space-y-4 p-5">
              ...
              <div className="rounded-lg border border-gray-300 bg-white dark:border-gray-700 dark:bg-gray-900">
                <div className="flex flex-wrap gap-1 border-b border-gray-200 p-2 dark:border-gray-800">
                  ...
                  <ToolbarButton onClick={() => inlineInputRef.current?.click()}><ImagePlus size={14} /></ToolbarButton>
            ...
            <div className="border-t border-gray-200 bg-gray-50 p-5 dark:border-gray-800 dark:bg-gray-900/60 lg:border-l lg:border-t-0">
              ...
              <div className="overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-950">
                ...
                <div className="space-y-3 p-4">
                  ...
                  <div className="prose-preview text-sm text-gray-700 dark:text-gray-200" dangerouslySetInnerHTML={{ __html: previewHtml }} />
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4">
      <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-2xl dark:border-gray-800 dark:bg-gray-950">
        ...
        <div className="space-y-4 p-6">
          ...
          <div className="prose-preview text-gray-800 dark:text-gray-100" dangerouslySetInnerHTML={{ __html: detail.content || '' }} />
        </div>
      </div>
    </div>
  );
